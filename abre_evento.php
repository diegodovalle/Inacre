...
$id = addslashes($_GET["id"]);
	...
	$busca = "SELECT * FROM $tb8 WHERE id=$id";
...
if($imagem){ 
$mostra_foto = "<a href=\"../fotos_eventos/$imagem\" rel=\"lytebox[vacation]\" title=\"$titulo\"><img src=\"thumbnail_eventos.php?imagem=../fotos_eventos/$imagem\" align=\"center\" border=0 class=\"borda_fotos\"></a>";
 } else { 
 $mostra_foto = "";
 } 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th scope="col" align="left" width="50%" style="padding-top: 40px;padding-left:35px;font-weight:100"><b>Data do evento:</b> <? echo "$data_evento"; ?><br><b>Título:</b> <? echo "$titulo"; ?><br><br><? echo "$texto"; ?></th>
    <th scope="col" width="50%" align="center" style="padding-top: 40px;vertical-align:middle;padding-left:45px;"><? echo "$mostra_foto"; ?></th>
			...
			<br>
			<br>
			<center><a href="eventos.php" >[+] eventos</a></center>
			<br>
